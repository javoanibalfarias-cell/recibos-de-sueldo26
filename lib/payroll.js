...
function readRetenciones(ws, r){
  ...
  if(bruto > 0) addD('E','Jubilación', bruto * 0.11, null, '11%');
  // Ley 19032 / INSSJP: 3% del bruto
  if(bruto > 0) addD('G','Ley 19032 / INSSJP', bruto * 0.03, null, '3%');
  // Obra social media jornada: 3% del bruto
  if(bruto > 0) addD('I','Obra social media jornada', bruto * 0.03, null, '3%');
